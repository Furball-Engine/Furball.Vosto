...
namespace Furball.Vosto.ShadingLanguage.Lexer {
    ...
    public abstract record TokenValue {
        ...
        public record Function : TokenValue;
        public record Variable : TokenValue;

        public record AtSymbol : TokenValue;
        public record Input : TokenValue;
        public record Uniform : TokenValue;
        public record Varying : TokenValue;
        public record VixiePosition : TokenValue;
        public record VixieColor : TokenValue;

        public record TypeInteger : TokenValue;
        public record TypeVoid : TokenValue;
        public record TypeMatrix4X4 : TokenValue;
        public record TypeFloat : TokenValue;
        public record TypeFloat2 : TokenValue;
        public record TypeFloat3 : TokenValue;
        public record TypeFloat4 : TokenValue;
